...
ruta_remota_script = "REPOSITORIO/scripts/carpetas_mensuales.py"

# Ruta del archivo único de historial
ruta_historial = "/home/vagrant/LOGS/historial_carpetas_mensuales.txt"

# Validar argumento
if len(sys.argv) != 2:
    print("Uso: python ejecutar_carpetas_mensuales.py <etiqueta_host>")
    sys.exit(1)
...
try:
    ...
    print(f"Script ejecutado correctamente en {etiqueta} ({destino}).")
